...
def enable_persistence(
    ...
    activation_uuid = f"{parsed_args.persistence_id or 'standalone'}"
...
def _get_config_params(variables: dict) -> dict:
    ...
    result = {
        "syncInterval": 1000,  # How often to sync state between instances
        "stateCheckInterval": 500,  # How often to check for state changes
    }
